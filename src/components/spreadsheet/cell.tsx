...
//   @Watch('isSelected')
//  resetEdit() {
//   if (!this.isSelected) this.isEditing = false;
// }
...
//   setTimeout(() => {
//     if (!this.isEditing || this.hasEmitted) return;  // prevents double calls

//     const newValue = (e.target as HTMLElement).innerText;

//     if (newValue !== this.cell.value) {
...
private startEditing() {
  ...
  setTimeout(() => {
    ...
    if (el) {
      ...
      // el.insertAdjacentText('beforeend', this.cell.value);
       // load current value
      el.focus();
...
render() {
  // ✅ Always have a safe fallback cell
